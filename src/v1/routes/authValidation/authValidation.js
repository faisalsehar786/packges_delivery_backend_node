...
const validateRequest = (req, res, next) => {
  ...
  return apiResponse.validationErrorWithData(
    ...
    'Password validation failed Password must contain at least one number, one uppercase letter, one lowercase letter, and one special character, and be at least 8 characters long',
    'Invalid Data'
  )
}
